...
public final class ItemMessageBinding implements ViewBinding {
  ...
  private ItemMessageBinding(@NonNull ConstraintLayout rootView, @NonNull CardView messageContainer,
  ...
  public static ItemMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      CardView messageContainer = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemMessageBinding((ConstraintLayout) rootView, messageContainer, tvMessage);
    }
